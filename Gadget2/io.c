...
#ifndef OUTPUTMACMASS
  if(blocknr == IO_MACMASS)
    return 0;
#endif
...
void fill_Tab_IO_Labels(void)
{
  ...
  for(i = 0; i < IO_NBLOCKS; i++)
	...
	break;
      case IO_MACMASS:
	strncpy(Tab_IO_Labels[IO_MACMASS], "MACMASS", 4);
	break;
      case IO_ACCEL:
